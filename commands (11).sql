...
-- This database is created by the working process of the Asian food distribution company named "super food service" (made-up name). 
...
-- When the staff finishes picking up the products in each order, the order will be gethered in one run. 
